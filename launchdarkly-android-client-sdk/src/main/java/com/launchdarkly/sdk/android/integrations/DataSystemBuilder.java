...
public class DataSystemBuilder {
    ...
    /**
     * Produces the default mode table. This matches the pipelines previously
     * hardcoded in {@code FDv2DataSourceBuilder.makeDefaultModeTable()}.
     */
    @NonNull
    private static Map<ConnectionMode, ModeDefinition> makeDefaultModeTable() {
        ...
        table.put(ConnectionMode.BACKGROUND, new ModeDefinition(
                Collections.singletonList(pollingInitializer),
                Collections.<ComponentConfigurer<Synchronizer>>singletonList(backgroundPollingSynchronizer)
        ));
        return table;
    }
}
