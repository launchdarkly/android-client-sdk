...
public class EvaluationExposureDeduperTest {
    ...
    private static EvaluationExposureKey key(String flagKey) {
        return new EvaluationExposureKey(
                "mobile-key-hash", flagKey, LDValue.of("value"), 1, 2, "user-key");
    }
    ...
    private static EvaluationExposureKey otherResult(String flagKey) {
        return new EvaluationExposureKey(
                "mobile-key-hash", flagKey, LDValue.of("other-value"), 3, 2, "user-key");
    }
    ...
    private static EvaluationExposureKey unknownFlag(String flagKey, LDValue defaultValue) {
        return new EvaluationExposureKey("mobile-key-hash", flagKey, defaultValue,
    ...
    public void exposureKeyDistinguishesEveryComponent() {
        EvaluationExposureKey key = new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("value"), 1, 2, "user-key");
        ...
        assertNotEquals(key, new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("other-value"), 1, 2, "user-key"));
        assertNotEquals(key, new EvaluationExposureKey(
                "mobile-key-hash", "other-flag", LDValue.of("value"), 1, 2, "user-key"));
        assertNotEquals(key, new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("value"), 3, 2, "user-key"));
        assertNotEquals(key, new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("value"), 1, 4, "user-key"));
        assertNotEquals(key, new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("value"), 1, 2, "other-user-key"));
        // A hook shared across environments observes the same result once per environment.
        assertNotEquals(key, new EvaluationExposureKey(
                "other-mobile-key-hash", "flag", LDValue.of("value"), 1, 2, "user-key"));
    }
    ...
    public void reportsAgainWhenOnlyTheFlagValueChanges() {
        ...
        EvaluationExposureKey first = new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("first"), 1, 2, "user-key");
        EvaluationExposureKey second = new EvaluationExposureKey(
                "mobile-key-hash", "flag", LDValue.of("second"), 1, 2, "user-key");
    ...
    public void tracksTheSameFlagSeparatelyPerEnvironment() {
        EvaluationExposureDeduper deduper = new EvaluationExposureDeduper(100);
        EvaluationExposureKey primary = new EvaluationExposureKey("mobile-key-hash", "flag", 1, 2, "user-key");
        EvaluationExposureKey secondary = new EvaluationExposureKey("other-mobile-key-hash", "flag", 3, 4, "user-key");
